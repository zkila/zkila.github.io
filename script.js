...
var Game = {
    ...
    endGameMenu: function (text) {
        ...
        Pong.context.font = '45px Roboto';
        Pong.context.fillStyle = this.color;

        // Draw the rectangle behind the 'Press any key to begin' text.
        Pong.context.fillRect(
            Pong.canvas.width / 2 - 350,
            Pong.canvas.height / 2 - 50,
            700,
            110
        );
    ...
    update: function () {
        if (!this.over) {
            ...
            // if (this.player.move === DIRECTION.LEFT) this.player.x -= this.player.speed/2;
            // else if (this.player.move === DIRECTION.RIGHT) this.player.x += this.player.speed/2;
        ...
        if (this.player.score === rounds[this.round]) {
            ...
            if (!rounds[this.round + 1]) {
                this.over = true;
                setTimeout(function () { Pong.endGameMenu('You Won!'); }, 1000);
            } else {
